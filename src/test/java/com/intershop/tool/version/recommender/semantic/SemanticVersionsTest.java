...
public class SemanticVersionsTest
{
    ...
    public void testJettySupport()
    {
        ...
        assertEquals("specific jetty version major", "9.4.0.v20161208", SemanticVersions.getNewestVersion(UpdateStrategies.MAJOR, availableVersions, "9.3.13.v20161014"));
        assertEquals("specific jetty version patch", "9.3.14.v20161028", SemanticVersions.getNewestVersion(UpdateStrategies.PATCH, availableVersions, "9.3.13.v20161014"));
    }
}
