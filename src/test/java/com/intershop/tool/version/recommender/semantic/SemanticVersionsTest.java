...
public class SemanticVersionsTest
{
    ...
    {
        assertEquals("find newest patch", "1.2.4", SemanticVersions.getNewestVersion(UpdateStrategies.PATCH, AVAILABLE_VERSIONS, VERSION_1_2_1));
        assertEquals("find newest major", "4.4.4", SemanticVersions.getNewestVersion(UpdateStrategies.MAJOR, AVAILABLE_VERSIONS, VERSION_1_2_1));
    }

    @Test
    public void testGetNewest()
    {
        assertEquals("find newest patch", "4.4.5-rc1", SemanticVersions.getNewestVersion(UpdateStrategies.INC, AVAILABLE_VERSIONS, VERSION_1_2_1));
    }
